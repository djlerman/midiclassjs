...
function MidiFile(data)
		...
		if ((eventTypeByte & 0xf0) == 0xf0)
				...
				switch (subtypeByte)
					...
					case 0x51:
						...
						event.microsecondsPerBeat = ((stream.readInt8() << 16)
								+ (stream.readInt8() << 8) + stream.readInt8());
						return event;
					case 0x54:
					...
					case 0x7f:
						...
						return event;
					default:
						// console.log("Unrecognised meta event subtype: " +
						// subtypeByte);
			...
			switch (eventType)
				...
				default:
					...
					/*
					 * console.log("Unrecognised MIDI event type: " +
					 * eventType); stream.readInt8(); event.subtype = 'unknown';
					 * return event;
					 */
				}
			}
	...
	for ( var i = 0; i < header.trackCount; i++)
		...
		if (trackChunk.id != 'MTrk') { throw "Unexpected chunk - expected MTrk, got "
				+ trackChunk.id; }
