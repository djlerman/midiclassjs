...
function Replayer(midiFile, timeWarp, eventProcessor)
	...
	for ( var i = 0; i < midiFile.tracks.length; i++)
		...
		trackStates[i] =
			{
			'nextEventIndex' : 0,
			'ticksToNextEvent' : (midiFile.tracks[i].length ? midiFile.tracks[i][0].deltaTime
					: null)
			};
		}
	...
	function processEvents()
		...
		function processNext()
			...
			if (midiEvent.event.type == "meta"
				...
				{
				// tempo change events can occur anywhere in the middle and
				// affect events that follow
